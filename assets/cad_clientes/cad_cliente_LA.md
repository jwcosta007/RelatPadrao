...
| BU | `bu_aplicavel` | `[A PREENCHER]` |
| | `bu_origem` | `[A PREENCHER]` |
| | `bu_regra` | `[A PREENCHER]` |
...
| MapaAloc | `mapaaloc_arquivo` | `[A PREENCHER]` *(ex: `LA_MapaAloc.xlsx`, sem versão no nome)* |
| Moeda | `moeda` | `[A PREENCHER]` |
| Doc | `doc_especifico` | `[A PREENCHER]` |

---

## 2. Shape da `f_Base` — LA

| Bloco | Qtd |
|---|---|
| Núcleo universal | 23 |
| Condicionais ligadas | `[A PREENCHER]` |
| KPIs vivos | `[A PREENCHER]` |
| **Total** | `[A PREENCHER]` |
...
- Abordagem prevista: replicar DRE via padrão AZ.
- Sem data de janela definida.

---

*Versão 01 — 19/jun/2026*
*Preencher todos os campos [A PREENCHER] antes de processar dados do LA.*
